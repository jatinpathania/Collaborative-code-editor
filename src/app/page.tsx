...
import { Code2, Users, Zap, Shield, Shuffle, ArrowRight, Terminal, Globe, Lock, Activity, ChevronRight, Copy, ClipboardPaste } from 'lucide-react';
    ...
    const handleCopyPaste = async () => {
        if (roomId.trim()) {
            ...
            try {
                ...
                setRoomId(text.slice(0, 6));
                toast({ title: 'Pasted', description: 'Room ID pasted from clipboard.' });
            } catch {
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                required
                                            />
                                            <button type="button" onClick={handleCopyPaste} title={roomId.trim() ? "Copy Room ID" : "Paste Room ID"}
